...
children.push(bullet('Bugs (B): 7 — B1b, B2a, B3a, B3b, B3c, B3d, B3e'));
...
children.push(bullet('Server-only: 9 — ship without AAB cycle'));
...
children.push(bullet('both: 5 — B3a, B3d, F1d, F3a, T1a (parity-required when one surface ships)'));
...
children.push(bullet('2 (medium): 8 — B2a, F2a + F2b + F2c, T2a + T2b, I2a + I2b'));
children.push(bullet('3 (low): 7 — B3a + B3b + B3c + B3d + B3e, F3a, I3a'));
children.push(p('Total active = 19. Plus 10 closed-without-entry = 29.'));
