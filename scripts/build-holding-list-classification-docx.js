...
function classificationTable(rows) {
  const widths = { id: 8, desc: 30, notes: 54, sa: 8 };
  return new Table({
    rows: [
      new TableRow({
        tableHeader: true,
...
children.push(p('Four lists, each with the same column shape (ID | Description | Notes | Server/AAB):'));
