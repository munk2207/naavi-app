...
children.push(bullet('both: 6 — B1c, B3a, B3d, F1c, F3a, T1a (parity-required when one surface ships)'));
children.push(bullet('backend: 5 — F1b, T2b, I2a, I2b, I3a (shared backend; both surfaces benefit)'));
