...
(async () => {
  console.log('=== FRESH conversation: "Drive me to team standup" x3 ===');
  for (let i = 1; i <= 3; i++) {
    const r = await call([{ role: 'user', content: 'Drive me to team standup' }]);
    console.log(`trial ${i}:`, r.rawText);
  }

  console.log('\n=== Also fresh: "Drive me to Team standup" (capital T, matching real title) ===');
  const r2 = await call([{ role: 'user', content: 'Drive me to Team standup' }]);
