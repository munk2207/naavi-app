...
(async () => {
  console.log('=== Linda contact ===');
  console.log((await call('What is Linda\'s email and phone number?')).rawText);

  console.log('\n=== James contact ===');
  console.log((await call('Tell me about James.')).rawText);

  console.log('\n=== Reyes Build billing (Demo 6) ===');
  console.log((await call('How much has Reyes Build billed me?')).rawText);
})();
