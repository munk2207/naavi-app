...
(async () => {
  console.log('=== Create work list ===');
  console.log((await call('Create a work list')).rawText);

  console.log('\n=== Add items ===');
  console.log((await call('Add "Order flooring for Riverside project", "Call inspector about permit", "Send Reyes Build invoice", and "Follow up with electrician" to my work list')).rawText);
})();
