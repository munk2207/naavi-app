/**
 * Build docs/TEST_RESPONSIBILITY_MATRIX.docx from the matching markdown.
 *
 ...
 *
 * Run:  node scripts/build-test-responsibility-matrix-docx.js
...
const MD_PATH  = path.join(__dirname, '..', 'docs', 'TEST_RESPONSIBILITY_MATRIX.md');
const OUT_PATH = path.join(__dirname, '..', 'docs', 'TEST_RESPONSIBILITY_MATRIX.docx');
...
const doc = new Document({
  creator:  'MyNaavi build-test-responsibility-matrix-docx',
  title:    'MyNaavi — Test Responsibility Matrix',
  styles: {
    paragraphStyles: [
      {
        id: 'Heading1',
