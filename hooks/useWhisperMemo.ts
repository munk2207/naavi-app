    ...
    if (isNative) {
      ...
      (async () => {
        try {
          ...
          // Low-bitrate mono M4A — small file, Whisper-compatible
          // Use numeric values to avoid enum import issues
    ...
    if (isNative) {
      ...
      (async () => {
        try {
          ...
          // Use string literal 'base64' to avoid EncodingType enum issues
