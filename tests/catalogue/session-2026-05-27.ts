...
export const session2026_05_27Tests: TestCase[] = [
  ...
  },
  {
    ...
    category: 'b6d',
    description:
      'B6d/Nav-disambiguation — PROMPT_VERSION must be 2026-06-14-v109-time-anchor-split (latest live version). ' +
    ...
    async run(ctx) {
      ...
      expectTruthy(
        version === '2026-06-14-v109-time-anchor-split',
        `Expected version "2026-06-14-v109-time-anchor-split", got "${version}"`,
      );
    },
  },
  {
