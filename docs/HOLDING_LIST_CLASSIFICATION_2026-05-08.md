...
| B3c | Haptic vibration feels too subtle on Samsung long-press | mobile | Long-press confirmation buzz (the primary hands-free entry on the chat surface) feels too subtle on Samsung even with system haptics maxed. Bump duration or use a pattern. AAB required; A/B during next AAB cycle. | AAB |
